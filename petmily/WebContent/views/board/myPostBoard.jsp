...
<%@ page import= "com.kh.member.model.vo.Member, java.util.ArrayList, com.kh.board.model.vo.Board, com.kh.adoption.model.vo.Animal" %>
    
<%



    ArrayList<Board> listVR = (ArrayList<Board>)session.getAttribute("listVR");

    ArrayList<Animal> listAP = (ArrayList<Animal>)session.getAttribute("listAP");
    
    ArrayList<Board> listVLCM = (ArrayList<Board>)session.getAttribute("listVLCM");
       ...
       // Attachment at = (Attachment)session.getAttribute("at");
        ...
        <div id="navigator">
            ...
            <div id="navi">
                ...
                <a href="<%= contextPath %>/myPost.bo">내가 쓴 글 조회</a>
            </div><!--navi-->
                        ...
                        <table align="center" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <% for(Board b : listVR) { %>
                                    <tr>
                                        <td><%= b.getComNo() %></td>
                                        <td><a href="<%=contextPath%>/detail.cm?cno=<%= b.getComNo() %>&type=<%= b.getComType() %>"><%= b.getComTitle() %></a></td>
